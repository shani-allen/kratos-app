...
func (c *personServiceClient) GetPersonById(ctx context.Context, in *GetPersonIdRequest, opts ...grpc.CallOption) (*Person, error) {
	out := new(Person)
	err := c.cc.Invoke(ctx, PersonService_GetPersonById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPersonServiceServer) GetPersonById(context.Context, *GetPersonIdRequest) (*Person, error) {
...
func _PersonService_GetPersonById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).GetPersonById(ctx, req.(*GetPersonIdRequest))
	}
